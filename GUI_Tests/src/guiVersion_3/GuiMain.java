...
public class GuiMain extends JFrame implements ActionListener, FocusListener{
	...
	JLabel timeSlotLabel		= new JLabel("Current Time Slot: ");
	...
	JLabel netAreaTitle			= new JLabel("botID-prnt-timeSlot-hh-mm-ss");
	...
	public void Gui_Init(){
		...
		netAreaTitle.setFont(new java.awt.Font("Tahoma", 1, 14));
		netAreaTitle.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
		
		numChildText.setText("1");
		dataPacketText.setText("0,0,0"); //botId, parent, timeSlot
	...
	public void createObjects(){
		...
		networkThread = new Thread(networkProtocol);
		networkThread.setName("AAAAGGGHHH");
	}	
	...
	public void actionPerformed(ActionEvent evt){
		...
		if (evt.getSource() == connectBtn) {
			...
			serialPortManager.writeData(botId, parent, timeSlot);
			System.out.println(networkThread.getName() + " 's status is: " + networkThread.getState());
