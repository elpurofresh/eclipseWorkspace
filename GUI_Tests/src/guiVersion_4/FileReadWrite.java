...
public class FileReadWrite {
	...
	String outputFileName = "C:\\andres\\Code\\eclipseWorkspace\\GUI_Tests\\src\\guiVersion_4\\data\\networkDataLog" + dateFormat.format(date) + ".txt";
	...
	public void WriteData(Package packageData){
		...
		try {
			...
			//output = new BufferedWriter(new FileWriter(outputFile));
			output.append(packageData.botID + "\t" + packageData.packetParent + "\t" + packageData.packetTimeSlot + "\n");	
