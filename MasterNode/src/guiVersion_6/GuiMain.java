...
public class GuiMain extends JFrame implements ActionListener /*, FocusListener*/{
	...
	public void actionPerformed(ActionEvent evt){
		...
		if (evt.getSource() == connectBtn) {
			...
			System.out.println("DisconButton -> " + networkThread.getName() + " 's status is: " + networkThread.getState());
			...
			System.out.println("DataPcktTestButton->" +networkThread.getName() + " 's status is: " + networkThread.getState());
		}
